<!doctype html>
<html <?php language_attributes(); ?> class="bg-light bg-dark">
<head>
        ...
        <div class="row g-0 h-100">
            ...
            <div class="col-12 col-lg-4 h-100">
                <form class="d-flex w-100 h-100 align-items-center justify-content-center" role="search">
                    <input class="form-control me-2" type="search" placeholder="Search" aria-label="Search" style="flex: 1; height: 3.0rem;">
